...
from autoppia_iwa.src.web_agents.classes import IWebAgent, TaskSolution, task_use_case_name_for_miner
    ...
    async def solve_task(self, task: Task) -> TaskSolution:
        ...
        async with aiohttp.ClientSession(timeout=timeout) as session:
            try:
                ...
                uc_name = task_use_case_name_for_miner(task)
                if uc_name is not None:
                    payload["use_case"] = uc_name
