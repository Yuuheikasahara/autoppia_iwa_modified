...
`use_case` is included when the benchmark task has a use case (same event name as demo webs, e.g. `FILM_DETAIL`). Miners may use it instead of classifying the prompt.
